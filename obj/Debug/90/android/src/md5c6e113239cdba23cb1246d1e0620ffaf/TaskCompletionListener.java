package md5c6e113239cdba23cb1246d1e0620ffaf;
...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("FuraRider.EventListeners.TaskCompletionListener, FuraRider", TaskCompletionListener.class, __md_methods);
	}
	...
	public TaskCompletionListener ()
	{
		...
		if (getClass () == TaskCompletionListener.class)
			mono.android.TypeManager.Activate ("FuraRider.EventListeners.TaskCompletionListener, FuraRider", "", this, new java.lang.Object[] {  });
	}
